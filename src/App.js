...
import CorporateProtection from "./pages/CorporateProtection";
import Loader from './components/Loader';
import KeyPersonInsurance from './pages/KeyPersonInsurance';
  ...
  return (
    <>
      ...
      <Routes>
        ...
        <Route path="/corporate-protection" element={<CorporateProtection />} />
        <Route path="/complaints" element={<Complaints />} />
        <Route path="/key-person-insurance" element={<KeyPersonInsurance />} />
        <Route path="/form-submitted" element={<SubmissionSuccess />} />
      </Routes>
      <Footer />
    </>
  );
