  ...
  return (
    <footer id="footer">
          ...
          <div className="footer-content">
            ...
            <div className="link-list">
              ...
              <ul className="footer-links">
                ...
                <li>
                  <Link to="/complaints#footer">Complaints</Link>
                </li>
              </ul>
            </div>
      ...
      <div className="footer-btm">
        <span>
        © 2025 The Lending Company. All Rights Reserved. The Lending Company is a Trading Style of Hassen Draper which is Authorised and Regulated by the Financial Conduct Authority, FCA number: 918885.
        </span>
      </div>
    </footer>
  );
