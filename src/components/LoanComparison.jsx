...
const LoanComparison = ({ comparetText }) => {
  ...
  <div className="loading-content">
    <h3
      ...
      style={{ color: "white", textAlign: "center", fontSize: "1.8em", marginBottom: "20px" }}
    >
      We're searching the entire market to find you the best deal possible, this might take a while...
    </h3>
    <p
      className="disclaimer-text"
      style={{ color: "white", textAlign: "center", fontSize: "0.9em", marginTop: "10px" }}
    >
      Disclaimer: The figures provided are for illustrative purposes only and do not constitute a formal mortgage offer. The Lending Company acts as a mortgage broker and not a lender. All mortgage applications are subject to the applicant(s) meeting the eligibility criteria and underwriting requirements of the specific lender. Final loan terms, including interest rates and monthly payments, may vary based on individual circumstances and lender assessment. A comprehensive evaluation of your financial situation, goals, and needs will be conducted prior to any formal recommendation being made.
    </p>
      ...
      <p className="loading-fact" style={{ fontWeight: "bold", fontSize: "1.8em", marginTop: "10px" }}>
        {currentFact}
      </p>
    </div>
  </div>
