    ...
    <>
      ...
      <div className="form-container" style={{ paddingBottom: "60px", backgroundColor: "#fff", minHeight: "120vh" }}>
        <div className="form-box">
          <h2 className="form-title">Loan Enquiry</h2>
                ...
                <div className="form-group">
                  ...
                  <div className="radio-group">
                    <label className="radio-label">
                      <input
                        type="radio"
                        name="ownMultipleProperties"
                        value="Yes"
                        onChange={(e) => setOwnMultipleProperties(e.target.value)}
                        checked={ownMultipleProperties === "Yes"}
                      />
                      Yes
                    </label>
                    <label className="radio-label">
                      <input
                        ...
                        value="No"
                        onChange={(e) => setOwnMultipleProperties(e.target.value)}
                        checked={ownMultipleProperties === "No"}
                      />
                      No
                    </label>
                  </div>
    ...
    {bestTimeToCall === "Other" && (
      <>
        ...
        {otherDate && (
          ...
          <p className="repossess-warning">Your home maybe repossessed if you do not keep up repayments on your mortgage. </p>
