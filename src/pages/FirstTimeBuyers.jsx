    ...
    <>
      ...
      <div className="form-container">
        <div className="form-box">
          ...
          <p className="form-subtext">Please fill your details, one of our experienced mortgage advisors will personalise your rate.</p>
      ...
      <QualitySection
        ...
        description="At The Lending Company, we simplify the mortgage process for first-time buyers. From mortgage pre-approval to finalizing your loan, our expert advisors ensure you get the best mortgage deal suited to your financial situation. We offer flexible solutions, competitive rates, and personalised advice to make your homeownership journey stress-free."
